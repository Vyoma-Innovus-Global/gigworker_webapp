...
export const getAllLanguagesAPI = async (user_id = 0) => {
  try {
    return await callApi("getAllLanguage", { user_id });
  } catch (error) {
...
export const getAllNatureIndustryAPI = async (user_id = 0, occupation_type_id) => {
  try {
    return await callApi("getAllNatureIndustry", { user_id, occupation_type_id });
  } catch (error) {
...
export const getGigWorkerAadharVerifiedDetailsAPI = async (
  ...
  try {
    return await callApiWithoutToken("getGigWorkerAadharVerifiedDetails", {
      application_id
    });
  } catch (error) {
    console.error("Error fetching Gig Worker Basic Info:", error);
...
export const getBlockMunicipalityCoorporationAPI = async (
  subdivision_id
) => {
  try {
    return await callApi("getBlockMunicipalityCoorporation", {
      subdivision_id
    });
  } catch (error) {
    console.error("Error fetching boundary details:", error);
...
export const getGPWardDetailsAPI = async (
  block_municipality_corp_id
) => {
  try {
    return await callApi("getGPWardDetails", {
      block_municipality_corp_id
    });
  } catch (error) {
    console.error("Error fetching boundary details:", error);
